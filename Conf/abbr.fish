...
abbr --add --global -- build-home 'time home-manager switch -f ~/voidrice/Conf/home.nix'
abbr --add --global -- clean 'sudo nix-store --gc && sudo nix-collect-garbage -d'
abbr --add --global -- install 'nix-env -f '\''<nixpkgs>'\'' -iA'
abbr --add --global -- update 'sudo nix-channel --update && sudo nix-env -u && sudo nixos-rebuild switch'
